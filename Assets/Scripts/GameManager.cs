...
    }
    ...
    // --- (Aquí irían DispararReaccion, RutinaReaccionTico, VolverANeutral y QuedanBurbujasDeColor tal cual los tenías) ---
    // (Omitidos en este bloque por espacio, pero mantenlos igual en tu script)
